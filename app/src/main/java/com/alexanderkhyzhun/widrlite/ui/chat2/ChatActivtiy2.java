package com.alexanderkhyzhun.widrlite.ui.chat2;
 ...
 */
public class ChatActivtiy2 extends AppCompatActivity implements RoomListener {

    // replace this with a real channelID from Scaledrone dashboard
    private String channelID = "xLrhvoc0sDBIzbgf";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scaledrone.connect(new Listener() {
            ...
            public void onOpen() {
                ...
                scaledrone.subscribe(roomName, ChatActivtiy2.this);
            }
